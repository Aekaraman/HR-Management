...
namespace HRManagement.WebUI.Controllers
{
    public class SettingsController : Controller
    {
        ...
        {
            personel = PersonelRepository.PersonelsRepository.GetPersonelByID(long.Parse(Request.Cookies["UserID"]));
        ...
        public IActionResult ChangeActiveStatu(long ID)
        {

            PersonelRepository.PersonelsRepository.ChangeActiveStatu(ID);
            return RedirectToAction("Index", PersonelRepository.PersonelsRepository.GetPersonelByID(ID));
        }
